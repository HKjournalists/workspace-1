...
public class MyClient {
	...
	public RequestResult getHtml(String url, String charset) {
		...
		if (flag) {
			html = postMethodHtml(url, charset).getHtml();
			if (html == null || html.isEmpty()) {
	...
	public RequestResult postMethodHtml(String url, String charset) {
	...
	public static void main(String[] args) throws Exception {
		...
		client.getHtml("http://jingqu.travel.sohu.com/pcl-100447.shtml", "gbk").getHtml();
	}
}
