...
public class ChineseNumber {
	...
	public static int normalizeNumber(String number) {
		...
		/*
		 * if (number.equals("一")) { num = 1; } else if (number.equals("二")) {
		 * num = 2; } else if (number.equals("三")) { num = 3; } else if
		 * (number.equals("四")) { num = 4; } else if (number.equals("五")) { num
		 * = 5; } else if (number.equals("六")) { num = 6; } else if
		 * (number.equals("七")) { num = 7; } else if (number.equals("八")) { num
		 * = 8; } else if (number.equals("九")) { num = 9; } else if
		 * (number.equals("十")) { num = 10; } else { num = 0; }
		 * 
		 * return num;
		 */
	}
	...
	public static void main(String[] args) {
		...
		int num = 0;
		number = "二";
		num = ChineseNumber.normalizeNumber(number);
